...
<main id="maincontent">
    ...
    <div class="row">
        ...
        <div class="background bg-black no-padding">
            <div class="container">
                <h2 class="text-white" style="margin-top: 40px; padding-bottom: 10px; border-bottom: 5px solid #666;">Diving for Gold in West Africa</h2>
                <figure>
    ...
    <div class="container standard-padding margin-top-medium">
        <div class="row">
            <div class="panel-center col-md-5">
                ...
                <h2>Gustavus Vassa Provides for His Family</h2>
                <p class="caption-text bold-text">Reference: PROB 10/3372</p>
            ...
            <div class="panel-center col-md-5">
                ...
                <p class="margin-top-large icon-label">Explore</p>
                <h2>Aliquam Sodales Viverra Lorem</h2>
                <p class="caption-text bold-text">Reference: PROB 10/3372</p>
                <p class="margin-top-small">
                    The will of Olaudah Equiano (Gustavus Vassa) is revealing. Made on 28 May 1796 and proved on 8 April 1797, it shows a man
                    who has established himself in Britain and played an active part in contemporary life. He owns property, which he bequeaths
    ...
    <div class="background border-top-grey">
        <div class="container">
            <div class="row">
                <div class="separator-icon">
                    <img style="height: 65px;width:65px;margin: 5px 0 0 -3px;" src="images/insights-shakespeare-v3/learn-icon.png" alt="Learn icon">
    ...
    <div class="background border-top-grey">
        <div class="container">
            <div class="row">
                <div class="separator-icon">
                    <img style="height: 65px;width:65px;margin: 5px 0 0 -3px;" src="images/insights-shakespeare-v3/audio-icon.png" alt="Read icon">
                    <p class="margin-top-small icon-label">Listen</p>
                </div>
            </div><!-- end row -->
        </div><!-- end container -->
    </div><!-- end background -->
