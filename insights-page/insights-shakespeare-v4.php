...
<main>
                ...
                <div class="container">
                    <div class="row">
                        <div class="badge-container">
                            <div class="badge">
                                <h2><span>Collection</span> <span class="middle"><b>insight</b></span> <span>14 May 2021</span></h2>
                            </div><!-- end badge -->
                        </div><!-- end badge-container -->
                        <div class="menu-container menu-container-version-4">
                            <h2>On this page</h2>
                            <ol>
                                <li>
    ...
    <div class="background bg-light-grey no-padding">
        <div class="container">
            <div class="row">
                <div class="col-md-4 author-image">
    ...
    <div id="section-1" class="section-separator">
        <div class="row">
            <div class="col-md-5"></div>
            <div class="col-md-2">
                <h2 class="section-separator-heading">Section 1</h2>
            </div>
            <div class="col-md-5"></div>
        </div><!-- end row -->
    </div>
    ...
    <div class="row">
                ...
                <figure>
                    <div class="record-embed-image">
                        <a href="#">
                            ...
                            <img class="content-image" src="images/insights-shakespeare-v1/shakespeare.png" alt="Shakespeare's portrait">
                        </a>
        ...
        <div class="background bg-dark-grey text-white">
            <div class="container">
                ...
                <p>The portrait shows a balding man, dark haired, rather askew of eye, and wearing a white lace collar of a type familiar to anyone who has read anything about William Shakespeare. The image itself is quite easily explained. It is a pencil copy, made in the 19th century by an antiquarian and archivist, of a 17th century portrait. But is this an image of Shakespeare, and why is it in the collections of The National Archives at all?</p>
                <p>The expert among whose papers it was found was Rawdon Lubbock Brown who, as you may have read in a blog earlier this year, was among the staff of the then-Public Record Office… but in Venice.</p>
                <a class="button" href="http://discovery.nationalarchives.gov.uk/details/r/C3604789" target="_blank" rel="noopener noreferrer">View in the catalogue</a>
                <a class="button" href="https://blog.nationalarchives.gov.uk/face-william-shakespeare/" target="_blank" rel="noopener noreferrer">Read more in our blog</a>
            </div><!-- end container -->
        </div><!-- end background -->
    ...
    <div class="background bg-blue">
        <div class="container call-out-box">
            <div class="row">
                <p>Whilst the registry record of Shakespeare’s birth is held in Stratford-upon-Avon and his November 28th 1582 marriage bond to Anne Hathaway is now in Worcestershire Record Office, a series of important records of his life are held at The National Archives, including pleadings and depositions in three lawsuits in the Court of Requests involving Shakespeare.</p>

                <div class="call-out-links">
                    <ul>
                        <li><a href="http://discovery.nationalarchives.gov.uk/details/r/C5904894" target="_blank" rel="noopener noreferrer"><span class="heading">The case of Belott versus Mountjoy</span>
                                <p class="no-margin-bottom">This concerns a marriage dowry and contains Shakespeare’s signed deposition. The documents pinpoint his residence in 1604.</p>
                            </a>
                        </li>
                        <li><a href="http://discovery.nationalarchives.gov.uk/details/r/C2677795" target="_blank" rel="noopener noreferrer"><span class="heading">The case of Keysar versus Burbage and others</span>
                                <p class="no-margin-bottom">This describes the King’s Men acting company’s involvement in the Blackfriars Playhouse.</p>
                            </a>
                        </li>
                        <li><a href="http://discovery.nationalarchives.gov.uk/details/r/C5904893" target="_blank" rel="noopener noreferrer"><span class="heading">The case of Witter versus Heminges and Condell</span>
                                <p class="no-margin-bottom">This describes the way in which the shares in the syndicate that leased the Globe playhouse were distributed.</p>
                            </a>
                        </li>
                    </ul>
                </div><!-- end call-out links -->
        ...
        <div class="row">
            <div class="panel-center">
                <div class="separator-icon">
                    <img style="height: 65px;width:65px;margin: 5px 0 0 -3px;" src="images/insights-shakespeare-v3/explore-icon.png" alt="audio icon">
                </div><!-- end separator-icon -->
                <p class="margin-top-large icon-label">Explore</p>
                <h2>Shakespeare and James I</h2>
                <p class="caption-text bold-text">Reference: LC 2/4/5</p>
                <p class="margin-top-small">Other documents at The National Archives reveal the growing status and prestige of Shakespeare, as, for example, the 1604 Progress of James I through the city of London, which mentions a grant of cloth to Shakespeare.</p>
                <a class="button-inverted" href="http://discovery.nationalarchives.gov.uk/details/r/C213527 " target="_blank" rel="noopener noreferrer">View in the catalogue</a>
    ...
    <div class="background image-audio">
        ...
        <div class="container margin-top-medium standard-padding">
            <div class="row">
                <div class="panel-center text-white">
                    <div class="separator-icon border-less">
                        <img style="height:65px;width:65px;margin: 5px 0 0 -3px" src="images/insights-shakespeare-v3/audio-icon.png" alt="audio icon">
                    </div>
                    <p class="margin-top-x-large icon-label">Listen</p>

                    <h2>A tourist’s guide to Shakespeare’s London</h2>
                    <p class="caption-text bold-text">Tuesday 13 September 2016</p>
                    <p>Discover what it was like to wander the streets of Shakespeare’s London. Though large portions of the city from Shakespeare’s time have since been destroyed by fire, war and developers, a surprising number of buildings and places still survive. Author David Thomas discusses the sights, cuisine and pastimes of 16th century Londoners, while providing insight into what it was like to be a tourist during Shakespeare’s lifetime. Please note that there are occasional disruptions to the sound quality during this recording.</p>

                    <a class="button-inverted" href="https://media.nationalarchives.gov.uk/index.php/tourists-guide-shakespeares-london/" target="_blank" rel="noopener noreferrer">Listen now</a>
                </div><!-- end panel-center-->
            </div><!-- end row -->
        </div><!-- end container -->
    </div><!-- end background -->
    ...
    <div id="section-2" class="section-separator">
        <div class="row">
            <div class="col-md-5"></div>
            <div class="col-md-2">
                <h2 class="section-separator-heading">Section 2</h2>
            </div>
            <div class="col-md-5"></div>
        </div><!-- end row -->
    </div>
    ...
    <!-- CONTENT SLICE 4 -->
    <div class="standard-padding content-slice--grey">
        <div class="container">
            <div class="row">
        ...
        <div class="row">
            <div class="research-resources">
                ...
                <ul class="research-links">
                    <li>
                        <a href="https://www.nationalarchives.gov.uk/education/resources/tudor-entertainment/" target="_blank" rel="noopener noreferrer">
                        <span class="heading">
                            Tudor Entertainment
                        </span>
                            <p class="no-margin-bottom">
                    ...
                    <li>
                        <a href="https://www.nationalarchives.gov.uk/education/resources/james-i/" target="_blank" rel="noopener noreferrer">
                        <span class="heading">
                            James I
                        </span>
                            <p class="no-margin-bottom">
    ...
    <div id="section-3" class="section-separator">
        <div class="row">
            <div class="col-md-5"></div>
            <div class="col-md-2">
                <h2 class="section-separator-heading">Section 3</h2>
            </div>
            <div class="col-md-5"></div>
        </div><!-- end row -->
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="blog-embed margin-bottom-medium">
                ...
                <a class="button-inverted text-center" href="https://blog.nationalarchives.gov.uk/shakespeares-will-new-interpretation/" target="_blank" rel="noopener noreferrer">Read the full blog</a>
            </div><!-- end blog embed -->
        </div><!-- end row -->
    </div><!-- end container -->
    ...
    <div class="row">
        ...
        <div class="background bg-dark-grey text-white">
            <div class="container">
                ...
                <a class="button" href="https://www.nationalarchives.gov.uk/education/resources/william-shakespeare/source-1/" target="_blank" rel="noopener noreferrer">View our classroom resource</a>
            </div><!-- end container -->
        </div><!-- end background -->
            ...
            <div class="row">
                <div class="col-sm-12 col-md-6 col-lg-4">
                    <div class="card-group-secondary-nav">
                        <a href='https://blog.nationalarchives.gov.uk/kidnapped-order-child-actors-shakespeares-day/' class="card-group-secondary-nav__link" target="_blank" rel="noopener noreferrer">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                    <div class="card-group-secondary-nav">
                        <a href='https://media.nationalarchives.gov.uk/index.php/philip-henslowe-edward-alleyn-and-the-invention-of-london-theatre-in-the-age-of-shakespeare/' class="card-group-secondary-nav__link" target="_blank" rel="noopener noreferrer">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                    <div class="card-group-secondary-nav">
                        <a href='https://www.eventbrite.co.uk/e/before-shakespeare-tickets-47213785704?aff=ebapi#' class="card-group-secondary-nav__link" target="_blank" rel="noopener noreferrer">
