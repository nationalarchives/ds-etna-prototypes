    ...
    <div class="container" id="results">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="/explorer/v1/time-periods">Time periods</a></li>
                <li class="breadcrumb-item"><a href="/explorer/v1/time-periods/medieval.php">Medieval</a></li>
