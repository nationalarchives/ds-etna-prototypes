    ...
    <div class="container" id="topics">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page"><a href=<?php echo "/explorer/topics-and-themes/index.php?topic=$parent_topic&topic_clean_name=$parent_topic_url_encoded" ?>><?php echo $parent_topic_clean ?></a></li>
