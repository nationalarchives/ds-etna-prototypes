!function () {
    ...
    document.addEventListener("DOMContentLoaded", (function () {
        (function () {
            ...
            var e = document.querySelector('div[data-id="cta-toggle-link-option-panel-b_5"]'),
                t = document.querySelector('div[data-id="cta-detailed-view-option-panel-b_5"]');
            if (e && t) {
                var r = document.createElement("button");
                r.innerText = "Access this record", r.classList.add("order-panel__toggle-button"), r.setAttribute("aria-expanded", !1), r.setAttribute("aria-controls", "hierarchy-togglee"), r.setAttribute("aria-label", "Access this record"), r.setAttribute("data-link-type", "Link"), r.setAttribute("data-link", "Access this record"), e.appendChild(r), t.id = "hierarchyTogglee", t.hidden = !0, r.addEventListener("click", (function (e) {
                    e.preventDefault();
                    var i = "true" == r.getAttribute("aria-expanded");
                    r.setAttribute("aria-expanded", !i);
                    var a = "true" == r.getAttribute("aria-expanded");
                    t.hidden = !t.hidden, a ? (r.innerHTML = "Hide access information", r.setAttribute("class", "order-panel__toggle-button open")) : (r.innerHTML = "Access this record", r.setAttribute("class", "order-panel__toggle-button"))
                }))
            }
        }()
    }))
