...
<div class="container">
    <h1>Display at museum</h1>
    <div class="variation">
        <h3>Staff</h3>

        <h4>This record is on display in <a href="#" data-webtrends-call="onsiteInfo">the Keepers’ Gallery</a></h4>
        <p><a href="#" title="Contact us" data-webtrends-call="unavailable">Contact us</a>
            to find out if you can view a copy at The National Archives.</p>
